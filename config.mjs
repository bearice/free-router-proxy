  ...
  return {
    ...
    routes: {
      'free-best': [
        ...
        { provider: 'orcarouter', model: 'orcarouter/free' },
        { provider: 'orcarouter', model: 'deepseek/deepseek-v4-flash-free' },
        { provider: 'orcarouter', model: 'deepseek/deepseek-v4-pro-free' },
